class BaseQuestion {
  ...
  init(params) {
    ...
    this.is_page_top = this.response.is_page_top || false;
    console.log(this.destination);

    this.createUIPageDiagnose();      
    this.is_page_top 
      ? this.createUIPageStartTop()
  ...
  createUIPageStartTop() {
    ...
    const buttonWrapper = this.createComponent("div", "d-flex p-15 gap-2");
    ...
    buttonEnneagram.appendChild(this.ComponentButton({
      text: "<small style='font-size: 2.6vw;'>決まっている方<br>─ 性格から導くステップアップ方法 ─</small><br/>診断スタート！",
    ...
    buttonCareerAnchor.appendChild(this.ComponentButton({
      text: "<small style='font-size: 2.6vw;'>決まっていない方<br>─ あなたの適職診断 ─</small><br/>診断スタート！",
      isClass: "btn--primary btn-start w-100",
